...
export default function PropertyCard({ property, viewMode = 'grid' }) {
  ...
  // Grid View
  return (
    <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-gray-100 flex flex-col h-full">
