  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content={`${property.title} - Bidding Details | REMMIC`} />
        <meta property="twitter:title" content={`${property.title} - Bidding Details | REMMIC`} />
                ...
                <div style={{display: 'flex', gap: '15px'}}>
                  ...
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: '12px',
                      background: isSubmitting ? '#9ca3af' : '#c9a227',
                      color: '#fff',
                      border: 'none',
                      borderRadius: '6px',
                      fontSize: '16px',
