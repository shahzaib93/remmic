...
export default function InvestmentShares() {
    ...
    try {
      ...
      const dummyInvestments = [
        ...
        },
        {
          ...
          status: 'active',
          type: 'investment',
          description: 'Luxury villa complex in Bahria Town with premium finishes and resort-style amenities.',
          image: 'https://images.unsplash.com/photo-1583608205776-bfd35f0d9f83?w=800&h=600&fit=crop',
          developer: 'Bahria Town',
        ...
        },
        {
          ...
          status: 'active',
          type: 'investment',
          description: 'Modern apartment complex with state-of-the-art facilities in prime Islamabad location.',
        ...
        },
        {
          ...
          status: 'active',
          type: 'investment',
          description: 'Premium office tower overlooking Lahore Canal with Grade-A specifications.',
          image: 'https://images.unsplash.com/photo-1507206942509-8b3b25a86e10?w=800&h=600&fit=crop',
          developer: 'Canal Developers',
          completionDate: '2025-11-30',
          shareOffering: {
            sharePrice: 550000,
            totalShares: 100,
            distributedShares: 69,
            availableShares: 31,
            minimumInvestment: 550000
          },
          sharesDistributedPercent: 89,
          sharesAvailablePercent: 11,
          fundingPercent: 89,
        ...
        },
        {
          ...
          shareOffering: {
            sharePrice: 950000,
            totalShares: 100,
            distributedShares: 15,
            availableShares: 85,
            minimumInvestment: 950000
          },
          sharesDistributedPercent: 89,
          sharesAvailablePercent: 11,
          fundingPercent: 89,
        ...
        },
        {
          ...
          image: 'https://images.unsplash.com/photo-1531973968078-9bb02785f13d?w=800&h=600&fit=crop',
          developer: 'DHA Lahore',
          completionDate: '2025-09-30',
          shareOffering: {
            sharePrice: 780000,
            totalShares: 100,
            distributedShares: 82,
            availableShares: 18,
            minimumInvestment: 780000
          },
          sharesDistributedPercent: 89,
          sharesAvailablePercent: 11,
          fundingPercent: 89,
        ...
        },
        {
          ...
          shareOffering: {
            sharePrice: 480000,
            totalShares: 100,
            distributedShares: 91,
            availableShares: 9,
            minimumInvestment: 480000
          },
          sharesDistributedPercent: 89,
          sharesAvailablePercent: 11,
          fundingPercent: 89,
  ...
  // Ensure we have data to show - add fallback data if empty
  const finalFilteredInvestments = filteredInvestments.length > 0 ? filteredInvestments : [
    {
      id: 'fallback-dha-phase-5',
      title: 'DHA Phase 5 Residential Complex',
      location: 'Lahore, Punjab',
      propertyType: 'Residential',
      riskLevel: 'Low',
      sharePrice: 250000,
      sharesAvailableCount: 22,
      totalShares: 100,
      sharesDistributedPercent: 78,
      sharesAvailablePercent: 22,
      expectedReturn: 18.5,
      shareChangePercent: 12.3,
      image: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=600&fit=crop',
      status: 'active',
      developer: 'DHA Lahore'
    },
    {
      id: 'fallback-gulberg-plaza',
      title: 'Gulberg Commercial Plaza',
      location: 'Islamabad, ICT',
      propertyType: 'Commercial',
      riskLevel: 'Medium',
      sharePrice: 420000,
      sharesAvailableCount: 11,
      totalShares: 100,
      sharesDistributedPercent: 89,
      sharesAvailablePercent: 11,
      expectedReturn: 22.3,
  ...
  const activeOpportunitiesCount = finalFilteredInvestments.length
  const activeOpportunityLabel = activeOpportunitiesCount === 1 ? 'opportunity' : 'opportunities'
  const heroPrimaryLocation = finalFilteredInvestments[0]?.location || availableLocations[0] || 'Multiple markets'
  const heroStats = [
    {
            ...
            <div className="investment-market__shell">
              ...
              <div className="investment-market__results-summary">
                <span className="investment-market__results-count">
                  {finalFilteredInvestments.length} {finalFilteredInvestments.length === 1 ? 'opportunity' : 'opportunities'} found
                  {/* DEBUG: {JSON.stringify({ count: filteredInvestments.length, loading: isLoading })} */}
                </span>
              </div>
