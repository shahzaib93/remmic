...
import { ensurePropertyImage, formatCurrency } from '../utils/propertyStorage'
...
export default function InvestmentShares() {
  ...
  const loadInvestments = useCallback(async () => {
    ...
    try {
      ...
      const rawProperties = fetchedProperties
  ...
  const finalFilteredInvestments = filteredInvestments
