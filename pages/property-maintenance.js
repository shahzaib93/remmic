      ...
      <div style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)', minHeight: '100vh' }}>
        ...
        <main style={{ padding: '100px 24px 140px' }}>
          <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
            {/* Page Header */}
            <div style={{ 
              background: 'linear-gradient(135deg, #c9a227 0%, #d4b13d 45%, #e5c84d 100%)',
              borderRadius: '24px',
              padding: '48px',
              color: 'white',
              marginBottom: '48px',
                ...
                {MAINTENANCE_CATEGORIES.map(category => (
                  <button
                    ...
                    style={{
                      padding: '20px 24px',
                      borderRadius: '12px',
                      border: selectedCategory === category.id ? '2px solid #c9a227' : '1px solid #e5e7eb',
                      background: selectedCategory === category.id ? '#fff7ed' : 'white',
                      color: selectedCategory === category.id ? '#c9a227' : '#374151',
                      cursor: 'pointer',
                      textAlign: 'center',
                  ...
                  >
                    <div style={{ 
                      color: selectedCategory === category.id ? '#c9a227' : '#6b7280',
                  ...
                  {filteredContractors.map(contractor => (
                    <div
                      ...
                      style={{
                        padding: '32px',
                        borderRadius: '20px',
                        border: selectedContractor?.id === contractor.id ? '2px solid #c9a227' : '1px solid #f1f5f9',
